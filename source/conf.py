...
extensions = [
    ...
    'sphinx.ext.ifconfig', 'sphinx.ext.extlinks', 'sphinx.ext.pngmath',
    'sphinx.ext.graphviz']
...
copyright = '2011-2014, Marc Zonzon'
...
epub_title = 'Sphinx and Rest Memo'
epub_author = 'Marc Zonzon'
epub_publisher = 'Marc Zonzon'
epub_copyright = '2011-2014, Marc Zonzon'
